...
function AdminRegister() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await signup(formData.email, formData.password, formData.name, "admin", additionalInfo);
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-12 px-4">
      <div className="max-w-md mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center">
            ...
            <div className="mt-2 p-2 bg-red-100 border border-red-200 rounded-lg">
              <p className="text-red-800 text-sm">⚠️ Restricted Access - Admin Only</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-2xl font-bold mb-6 text-center text-gray-900">Admin Registration</h2>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 ${emailStatus==='taken' ? 'border-red-300' : 'border-gray-300'}`}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white font-semibold py-3 px-4 rounded-lg transition duration-200 ease-in-out transform hover:scale-105"
            >
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              <Link to="/login" className="text-red-600 hover:text-red-700 font-semibold underline">
                Sign in here
              </Link>
            </p>
          </div>
